...
SOPCINFO_FILE := D:/programs/FPGA/PLD/de2_115/myniosiicpu.sopcinfo
...
# Design Name 
# setting SOPC_NAME is myniosiicpu
SOPC_NAME := myniosiicpu
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x1002138
SOPC_SYSID_FLAG += --sidp=0x1002138
ELF_PATCH_FLAG  += --sidp 0x1002138

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1514451002
SOPC_SYSID_FLAG += --timestamp=1514451002
ELF_PATCH_FLAG  += --timestamp 1514451002
